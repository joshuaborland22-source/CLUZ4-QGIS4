...
class Ui_portfolioResultsDialog(object):
    def setupUi(self, portfolioResultsDialog):
        ...
        portfolioResultsDialog.setWindowModality(QtCore.Qt.WindowModality.ApplicationModal)
        ...
        self.statusTabTableWidget.setEditTriggers(QtWidgets.QAbstractItemView.EditTrigger.NoEditTriggers)
        ...
        self.spatialTabTableWidget.setEditTriggers(QtWidgets.QAbstractItemView.EditTrigger.NoEditTriggers)
        ...
        self.sfTabTableWidget.setEditTriggers(QtWidgets.QAbstractItemView.EditTrigger.NoEditTriggers)
        ...
        self.patchFeatTabTableWidget.setEditTriggers(QtWidgets.QAbstractItemView.EditTrigger.NoEditTriggers)
