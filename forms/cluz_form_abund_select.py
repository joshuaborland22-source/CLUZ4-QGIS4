...
class Ui_abundSelectDialog(object):
    def setupUi(self, abundSelectDialog):
        ...
        abundSelectDialog.setWindowModality(QtCore.Qt.WindowModality.ApplicationModal)
        ...
        self.featListWidget.setSelectionMode(QtWidgets.QAbstractItemView.SelectionMode.MultiSelection)
