...
#
    ...
    def runIdentifyFeaturesInSelected(self, setupObject):
        ...
        if setupObject.setupStatus == 'files_checked':
            ...
            self.Ui_identifySelectedDialog.exec()
...
#             result = self.patchesDialog.exec()
#
