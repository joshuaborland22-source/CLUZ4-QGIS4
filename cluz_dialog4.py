...
from .cluz_dialog4_code import addDetailsToSfTab, removeSuperfluousTabs, identifySelectedKeyPressEventCode, setInitialDistribtuionShapeFilePath, loadDistributionFeatureList, returnSelectedPUDetailsDict
from .cluz_dialog4_code import portfolioSfTabDialogKeyPressEvent, checkIfSfRunsValueIsOK, returnRichnessRestrictedRangeResults, makeSelectedFeatIDSet, create_displayDistributionMaps, addDetailsToSpatialTab
from .cluz_dialog4_code import makeSFFieldList, returnSelectedPUIDDict, addSelectedIdentifyDataToTableWidget, returnInitialFieldName, produceTypeTextList, addPatchFeatDetailsToPortfolioDict
from .cluz_dialog4_code import portfolioStatusTabDialogKeyPressEvent, addIrrepResults, addFormatting_HeadingsToTableWidget, addSfDetailsToPortfolioDict, returnRichnessCountResults
from .cluz_dialog4_code import portfolioSpatialTabDialogKeyPressEvent, checkRichnessTypeCodesSelected_OptionsSelected, portfolioPatchTabDialogKeyPressEvent, makeIrrepDictOutputFile, addDetailsToPatchFeatTab, addDetailsToStatusTab
    ...
    def runReturnPortfolioDetails(self, setupObject):
        ...
        if sfRunsValueIsOKBool:
            ...
            if len(portfolioPUDetailsDict) > 0:
                ...
                self.portfolioResultsDialog.exec()
